...
## For Python versjon 3

Denne boken vil lære deg å bruke Python versjon 3. Den inneholder også veiledning for deg som ønsker å bruke den eldre og mer utbredte versjonen Python 2.
...
Denne boken er til og med brukt av NASA! Den er bukt i deres [Jet Propulsion Laboratory](http://dsnra.jpl.nasa.gov/software/Python/byte-of-python/output/byteofpython_html/) i ”Deep Space Network” prosjektet.

<!-- ## Academic Courses -->
## Ved høyskoler og universitet

Denne boken brukes eller ble brukt som lærebok i ulike utdanningsinstitusjoner:
<!-- This book is/was being used as instructional material in various educational institutions: -->

- 'Principles of Programming Languages' kurs ved [Vrije Universiteit, Amsterdam](http://www.few.vu.nl/~nsilvis/PPL/2007/index.html)
- 'Basic Concepts of Computing' kurs ved [University of California, Davis](http://www.cs.ucdavis.edu/courses/exp_course_desc/10.html)
- 'Programming With Python' kurs ved [Harvard University](http://www.people.fas.harvard.edu/~preshman/python_winter.html)
- 'Introduction to Programming' kurs ved [University of Leeds](http://www.comp.leeds.ac.uk/acom1900/)
- 'Introduction to Application Programming' kurs ved [Boston University](http://www.cs.bu.edu/courses/cs108/materials.html)
- 'Information Technology Skills for Meteorology' kurs ved [University of Oklahoma](http://gentry.metr.ou.edu/byteofpython/)
- 'Geoprocessing' kurs ved [Michigan State University](http://www.msu.edu/~ashton/classes/825/index.html)
- 'Multi Agent Semantic Web Systems'  kurs ved [University of Edinburgh](http://homepages.inf.ed.ac.uk/ewan/masws/)
- 'Introduction to Computer Science and Programming' ved [MIT OpenCourseWare](http://ocw.mit.edu/courses/electrical-engineering-and-computer-science/6-00sc-introduction-to-computer-science-and-programming-spring-2011/references/)
- 'Basic programming' hos fakultet for samfunnsfag, Universitet i Ljubljana, Slovenia' -- [Aleš Žiberna](mailto:ales.ziberna@fdv.uni-lj.si) says _"I (and my predecessor) have been using your book as the main literature for this course"_

## Lisens

Denne boken er lisensiert under en [Creative Commons Attribution-ShareAlike 4.0 International](http://creativecommons.org/licenses/by-sa/4.0/deed.no) lisens.

Det betyr:

- Du kan fritt Dele — kopiere, distribuere og spre boken i hvilket som helst medium eller format
- Du kan fritt Bearbeide — remixe, endre, og bygge videre på materialet
- Du kan fritt bruke boken til hva du vil, også til kommersielle formål
...
- Vennligst *ikke* selg elektroniske kopier eller utskrifter av boken med mindre du klart og tydelig formidlet i beskrivelsen at disse kopiene *ikke* er fra den opprinnelige forfatteren av denne boken.
...
- All kode/alle skript som ligger ved denne boken er lisensiert under en [3-clause BSD License](http://www.opensource.org/licenses/bsd-license.php) med mindre noe annet er oppgitt.

<!-- ## Read Now -->
## Les nå

Du kan lese boken på nett på http://python.swaroopch.com og på Norsk fin-adresse.uib.no ?

<!-- ## Buy The Book -->
## Kjøp boken

En papirutgave av boken på engelsk kan kjøpes på http://www.swaroopch.com/buybook/ for lesing uten internettilgang, og for å støtte utviklingen og utbedringen av denne boken.
...
Besøk https://www.gitbook.com/book/swaroopch/byte-of-python/details for følgende typer nedlastinger:

- [PDF (for desktop, etc.)](https://www.gitbook.com/download/pdf/book/swaroopch/byte-of-python)
- [EPUB (for iPhone/iPad, eboklesere, etc.)](https://www.gitbook.com/download/epub/book/swaroopch/byte-of-python)
...
Besøk https://github.com/swaroopch/byte-of-python for å finne råmaterialet til boken (for rettelser, endringer, oversettelse, osv.)

<!-- the raw content (for suggesting corrections, changes, translating, etc.) -->
